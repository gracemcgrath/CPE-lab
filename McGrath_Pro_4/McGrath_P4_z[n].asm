...
Loop
	...
	memory_buffer
		movff value_2,value_z ; save x[n-2] into z[n]
		...
		movff value, value_1 ; save x[n] into x[n-1]
			...
			;		here or call a subroutine
	adder_divider
		addwf value_z ; add x[n] (from current contents of W) into value_z (AKA x[n-2])
		rrcf value_z, 1 ; divide by 2 for final z[n] value
