...
Loop
	...
	memory_buffer
		movff value_3, value_a ; save x[n-3] into a[n]
		...
		movff value, value_1 ; save x[n] into x[n-1]
			...
			;		here or call a subroutine
	adder_divider
		addwf value_a ; add x[n] (from current contents of W) into value_a (AKA x[n-3])
		rrcf value_a, 1 ; divide by 2 for final a[n] value
