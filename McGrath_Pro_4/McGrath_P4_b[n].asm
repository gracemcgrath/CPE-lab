...
Loop
	...
	memory_buffer
		movff value_4, value_b ; save x[n-4] into b[n]
		...
		movff value, value_1 ; save x[n] into x[n-1]
			...
			;		here or call a subroutine
	adder_divider
		addwf value_b ; add x[n] (from current contents of W) into value_b (AKA x[n-4])
		rrcf value_b, 1 ; divide by 2 for final a[n] value
