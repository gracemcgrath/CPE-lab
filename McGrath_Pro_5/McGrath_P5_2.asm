...
Loop
	...
	adder_divider
		addwfc value_a ; add current contents of W = x[n] + x[n-2] + x[n-4] into value_a = x[n-6]
		rrcf value_a ; value_a = (x[n] + x[n-2] + x[n-4] + x[n-6])/2
		rrcf value_a ; value_a = (x[n] + x[n-2] + x[n-4] + x[n-6])/4
